...
object BookQuery {
    const val SAVE_BOOK_QUERY: String = "Insert into books (book_tittle, language_id, collage_id, book_type) " +
            "VALUES (:bookTittle, :languageID, :collageID, :bookType);"

    const val UPDATE_BOOK_QUERY: String =
        "UPDATE books SET book_tittle = :bookTittle, language_id = :languageID, collage_id = :collageID, " +
