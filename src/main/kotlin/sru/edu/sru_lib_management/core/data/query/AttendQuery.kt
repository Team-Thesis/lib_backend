...
object AttendQuery {
    const val SAVE_ATTEND_QUERY = "INSERT INTO attend (student_id, entry_times, exiting_times, purpose, date)" +
            "VALUES( :studentID, :entryTimes, :exitingTime, :purpose, :date);"
    ...
    const val GET_ATTEND_QUERY_BY_STUDENT_ID = "SELECT * FROM attend WHERE student_id = :studentID"
